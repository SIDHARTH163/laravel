...
<html lang="en">
  ...
  <body>
    <nav class=" navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" style="font-weight:bold" href="/">Admin</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
    
      <div class="collapse navbar-collapse nv justify-content-end " id="navbarSupportedContent">
        <ul class="nav justify-content-end">
          <li class="nav-item">
            <a class="navbar-brand active" aria-current="page" href="/index">Home</a>
          </li>
          <li class="nav-item">
...
{{-- alrts ends --}}
      <div class="user_forms-login">
        ...
        <form class="forms_form" action="alogin" Method="POST">
            @csrf
          ...
          <div class="forms_buttons">
            <button type="button" name=submit class="forms_buttons-forgot">Forgot password?</button>
      ...
      <div class="user_forms-signup">
        ...
        <form class="forms_form" action="/adminsignup" method="POST">
          @csrf
          <fieldset class="forms_fieldset">
            <div class="forms_field">
              <input type="text" name="fname" placeholder="Full Name" class="forms_field-input" required />
            </div>
            <div class="forms_field">
...
width: 100%;
height: 100vh;
background: url("https://images.pexels.com/photos/97077/pexels-photo-97077.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500") no-repeat center;
